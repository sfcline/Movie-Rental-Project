...
public abstract class Account {
     ...
     */
    private void setAccountID(int accountID) throws IllegalAccountArgumentException {
        if (accountID > 0) {
     ...
     * @throws IllegalAccountArgumentException thrown if invalid parameter is passed.
     */
    private void setFirstName(String firstName) throws IllegalAccountArgumentException {
     ...
     * @throws IllegalAccountArgumentException thrown if invalid parameter is passed.
     */
    private void setLastName(String lastName) throws IllegalAccountArgumentException {
     ...
     * @throws IllegalAccountArgumentException thrown if invalid parameter is passed.
     */
    private void setEmailAddress(String emailAddress) throws IllegalAccountArgumentException {
