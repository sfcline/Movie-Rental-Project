...
public class MovieRowMood {
    ...
    public MovieRowMood (ImageView Location1IV, ImageView Location2IV, ImageView Location3IV, ImageView Location4IV,
                        ImageView Location5IV, ImageView Location6IV, ImageView Location7IV, ImageView Location8IV,
                        ImageView Location9IV, ImageView Location10IV, ImageView Location11IV, ImageView Location12IV,
                        ImageView Location13IV, ImageView Location14IV, ImageView Location15IV, ImageView Location16IV,
                        Label Location1Lbl, Label Location2Lbl, Label Location3Lbl, Label Location4Lbl,
                        Label Location5Lbl, Label Location6Lbl, Label Location7Lbl, Label Location8Lbl,
                        Label Location9Lbl, Label Location10Lbl, Label Location11Lbl, Label Location12Lbl,
                        Label Location13Lbl, Label Location14Lbl, Label Location15Lbl, Label Location16Lbl) {
        ...
        IVList.add(Location9IV);IVList.add(Location10IV);IVList.add(Location11IV);IVList.add(Location12IV);
        IVList.add(Location13IV);IVList.add(Location14IV);IVList.add(Location15IV);IVList.add(Location16IV);
        ...
        LblList.add(Location9Lbl);LblList.add(Location10Lbl);LblList.add(Location11Lbl);LblList.add(Location12Lbl);
        LblList.add(Location13Lbl);LblList.add(Location14Lbl);LblList.add(Location15Lbl);LblList.add(Location16Lbl);
    }
    ...
    public ArrayList<Movie> setPostersWithMovieIDs(int Movie_ID1, int Movie_ID2, int Movie_ID3, int Movie_ID4,
                                                   ...
                                                   int Movie_ID9, int Movie_ID10, int Movie_ID11, int Movie_ID12,
                                                   int Movie_ID13, int Movie_ID14, int Movie_ID15, int Movie_ID16) {
        ...
        movieIdList.add(Movie_ID9);movieIdList.add(Movie_ID10);movieIdList.add(Movie_ID11);movieIdList.add(Movie_ID12);
        movieIdList.add(Movie_ID13);movieIdList.add(Movie_ID14);movieIdList.add(Movie_ID15);movieIdList.add(Movie_ID16);
