...
public class MovieRow {
    ...
    /**
     * Populates IVList and LBLList.
     *
     * @param recomendedList the values to use to populate.
     */
    ...
    /**
     * Populates a movie ArrayList when called.
     *
     ...
     * @return the Arraylist of movies populated.
     */
    ArrayList<Movie> setPostersWithMovieIDs(
            int Movie_ID1,
            int Movie_ID2,
            int Movie_ID3,
            int Movie_ID4,
    ...
    /**
     * Automatically populates a Row with movies of the given tag.
     *
     * @param Tag the tag to populate with.
     * @return the list of movies.
     * @throws IllegalMovieArgumentException thrown if illegal movie parameter is found.
     */
    ArrayList<Movie> autoSetRowWithTag(String Tag) throws IllegalMovieArgumentException {
        final String MOVIE_PREFIX = "https://image.tmdb.org/t/p/original";
        ArrayList<Movie> posterArray =
                moviePosterController.selectRANDOMMoviePostersFromMoviesWhereTagIs(Tag, 8);
